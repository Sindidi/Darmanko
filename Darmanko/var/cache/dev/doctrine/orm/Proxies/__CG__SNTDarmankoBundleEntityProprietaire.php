...
namespace Proxies\__CG__\SNT\DarmankoBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Proprietaire extends \SNT\DarmankoBundle\Entity\Proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'id', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'numpiece', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'nomComplet', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'adresse', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'tel', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'email', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'codeBanque', '' . "\0" . 'SNT\\DarmankoBundle\\Entity\\Proprietaire' . "\0" . 'password'];
        }
